<script lang="ts">
    ...
    import { defaultValue, type CropShape, type CropValue, type Media } from '$lib/types';
    ...
    let shape: CropShape = 'round';
    let crop_window_margin: number = 30;
    ...
    <div class="box">
        ...
        <div
            style="position:relative;height:100px;width:{value.aspect *
                100}px; overflow:hidden; border-radius: {shape == 'round' ? '50%' : '0'}"
        >
            {#if video}
                <video
        ...
        >
            ...
            <input type="color" bind:value={overlay_options.overlay_color} />
            <div>line color</div>
            <input type="color" bind:value={overlay_options.line_color} />
        ...
        <div>
            ...
            <select bind:value={overlay_options.show_third_lines}>
...
`}
    ...
    <div class="box">
        <h2>Props and defaults</h2>
            See <a href="https://github.com/sabine/svelte-crop-window#props">here</a>.
